...
import type {
  ...
  Student, Payment, FeeRecord,
  Personnel, TimeTracking, PersonnelAbsence, SalaryAdvance, CustomDeduction, DailyAttendance, SalaryCalculation,
  Subject, GradeWithSubject, StudentTermAverage, SubjectClassAverage,
  ClassSubject,
  CashJournalEntry, CashJournalFilters
} from '../shared/types'
...
interface APIType {
  ...
  cashJournal: {
    ...
    report: {
      monthlyFinance: (year: number, month: number) => Promise<{ success: boolean; data?: any; error?: string }>
